...
CharcoalKiln_MapEvents:
	...
	object_event  5,  6, SPRITE_FARFETCH_D_MOVE, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CharcoalKilnFarfetchd, EVENT_CHARCOAL_KILN_FARFETCH_D
