...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event  7, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceTMDarkPulse, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_DARK_PULSE
