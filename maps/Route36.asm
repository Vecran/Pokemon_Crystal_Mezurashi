	...
	const ROUTE36_FRUIT_TREE1
	const ROUTE36_ARTHUR
	const ROUTE36_FLORIA
	const ROUTE36_SUICUNE
	const ROUTE36_FRUIT_TREE2
...
Route36FruitTree1:
	fruittree FRUITTREE_ROUTE_36_1

Route36FruitTree2:
	fruittree FRUITTREE_ROUTE_36_2
...
Route36_MapEvents:
	...
	object_event 21,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route36FruitTree1, -1
	...
	object_event 20,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route36FruitTree2, -1
