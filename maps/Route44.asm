	...
	const ROUTE44_FRUIT_TREE1
	const ROUTE44_POKE_BALL1
	const ROUTE44_POKE_BALL2
	const ROUTE44_POKE_BALL3
	const ROUTE44_FRUIT_TREE2
...
Route44FruitTree1:
	fruittree FRUITTREE_ROUTE_44_1

Route44FruitTree2:
	fruittree FRUITTREE_ROUTE_44_2
...
Route44_MapEvents:
	...
	object_event  9,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44FruitTree1, -1
	...
	object_event 10,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44FruitTree2, -1
