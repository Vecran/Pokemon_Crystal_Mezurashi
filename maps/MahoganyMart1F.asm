...
MahoganyMart1FLanceUncoversStaircaseScript:
	...
	pause 15
	applymovement MAHOGANYMART1F_GIO, GiovanniMoveOutOfWayMovement
	...
	applymovement MAHOGANYMART1F_GIO, GiovanniToPlayerMovement
	faceobject PLAYER, MAHOGANYMART1F_GIO
	opentext
	writetext MahoganyMart1FGioLeavesText
	waitbutton
	closetext
	playsound SFX_EXIT_BUILDING
...
GiovanniMoveOutOfWayMovement:
	slow_step RIGHT
	slow_step RIGHT
	turn_head LEFT
	step_end

GiovanniToPlayerMovement:
	slow_step LEFT
	slow_step UP
	slow_step UP
	step_end

GiovanniLeavesMovement:
	slow_step LEFT
	slow_step DOWN
	slow_step DOWN
	slow_step DOWN
...
MahoganyMart1F_MapEvents:
	...
	object_event  5,  5, SPRITE_LANCE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
	object_event  4,  6, SPRITE_GIOVANNI_DISGUISE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
	object_event  3,  6, SPRITE_NIDOQUEEN_MOVE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
