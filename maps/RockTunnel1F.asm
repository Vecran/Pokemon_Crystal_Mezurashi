...
RockTunnel1F_MapEvents:
	...
	object_event 10, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, RockTunnel1FTMRockSlide, EVENT_ROCK_TUNNEL_1F_TM_ROCK_SLIDE
