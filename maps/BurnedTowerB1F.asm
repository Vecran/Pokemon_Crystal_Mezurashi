...
BurnedTowerB1F_MapEvents:
	...
	object_event 16,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, BurnedTowerB1FTMShadowClaw, EVENT_BURNED_TOWER_B1F_TM_SHADOW_CLAW
