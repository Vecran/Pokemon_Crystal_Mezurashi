...
CELADONGAMECORNERPRIZEROOM_TM29_COINS EQU 2500
CELADONGAMECORNERPRIZEROOM_TM15_COINS EQU 4500
CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 250
CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 1500
CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 3000
...
.MenuData:
	...
	db "WOBBUFFET  {d:CELADONGAMECORNERPRIZEROOM_PORYGON_COINS}@"
