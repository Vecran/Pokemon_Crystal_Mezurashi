	...
	const ROUTE30_RATTATA_UP
	const ROUTE30_FRUIT_TREE1
	const ROUTE30_FRUIT_TREE2
	const ROUTE30_COOLTRAINER_F
	const ROUTE30_POKE_BALL
	const ROUTE30_FRUIT_TREE3
	const ROUTE30_FRUIT_TREE4
...
YoungsterJoey_ImportantBattleScript:
	...
	applymovement ROUTE30_RATTATA_UP, Route30_JoeysRattataAttacksMovement
	opentext
	faceplayer
...
Route30FruitTree3:
	fruittree FRUITTREE_ROUTE_30_3

Route30FruitTree4:
	fruittree FRUITTREE_ROUTE_30_4
...
Route30_MapEvents:
	...
	object_event  5, 24, SPRITE_PIDGEY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_OW_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_30_BATTLE
	object_event  5, 25, SPRITE_RATTATA_UP, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_30_BATTLE
	...
	object_event  4, 39, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route30FruitTree3, -1
	object_event  13, 5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route30FruitTree4, -1
