...
Route30_MapEvents:
	...
	object_event  5, 25, SPRITE_RATTATA_UP, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_ICON_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_30_BATTLE
	...
	object_event 12, 4,  SPRITE_RATTATA_UP,	SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_ICON_PURPLE, OBJECTTYPE_SCRIPT, 0, Route30TestRattataUp, -1