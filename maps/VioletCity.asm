	...
	const VIOLETCITY_FRUIT_TREE1
	const VIOLETCITY_POKE_BALL1
	const VIOLETCITY_POKE_BALL2
	const VIOLETCITY_FRUIT_TREE2
...
VioletCity_MapEvents:
	...
	object_event 15, 21, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletCityFruitTree2, -1
