	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, BODY_SLAM, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, SHADOW_CLAW, FRUSTRATION, IRON_TAIL, RETURN, DIG, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, BULK_UP, REST, ATTRACT, THIEF, FIRE_PUNCH, FURY_CUTTER, ROCK_SLIDE, CUT, SURF, STRENGTH
	; end
