	...
	; tm/hm learnset
	tmhm DRAIN_PUNCH, HEADBUTT, CURSE, ROLLOUT, ROAR, TOXIC, CHARGE_BEAM, ROCK_SMASH, BODY_SLAM, HIDDEN_POWER, SUNNY_DAY, FALSE_SWIPE, SNORE, PROTECT, SHADOW_CLAW, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, REST, ATTRACT, THIEF, FIRE_PUNCH, FURY_CUTTER, CUT, STRENGTH
	; end
