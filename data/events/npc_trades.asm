...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, ABRA,       MACHOP,     "MUSCLE@@@@@", $37, $77, GOLD_BERRY,   37460, "MIKE@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, BELLSPROUT, RHYHORN,    "RAMPAGE@@@@", $99, $99, HARD_STONE,   48926, "KYLE@@@@@@@", TRADE_GENDER_EITHER
