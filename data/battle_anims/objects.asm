...
; ANIM_OBJ_BIND1
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_52, BATTLEANIMFUNC_WRAP, PAL_BATTLE_OB_GREEN, ANIM_GFX_ROPE
; ANIM_OBJ_BIND2
...
; ANIM_OBJ_SLUDGE_WAVE
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_23, BATTLEANIMFUNC_SURF, PAL_BATTLE_OB_BROWN, ANIM_GFX_BUBBLE
; ANIM_OBJ_HONE_CLAWS_DOWN_LEFT
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $85, BATTLEANIMFRAMESET_3E, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_CUT
; ANIM_OBJ_HONE_CLAWS_DOWN_RIGHT
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $85, BATTLEANIMFRAMESET_3F, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_CUT
; ANIM_OBJ_LEAF_SPLASH
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_RAZOR_LEAF, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT
