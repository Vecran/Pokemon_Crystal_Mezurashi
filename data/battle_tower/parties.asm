...
; BattleTowerMons group 1
	...
	db MR__MIME
	db FOCUS_BAND
	db PSYCHIC_M, ICE_PUNCH, CALM_MIND, REFLECT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db LAPRAS
	db NEVERMELTICE
	db ICE_BEAM, DRAGONBREATH, SING, THUNDERBOLT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db JOLTEON
	db SPELL_TAG
	db MUD_SLAP, GROWTH, THUNDERBOLT, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db MISDREAVUS
	db MIRACLEBERRY
	db ICY_WIND, CHARGE_BEAM, CONFUSE_RAY, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db WOBBUFFET
	db LEFTOVERS
	db HYPNOSIS, BULK_UP, MIMIC, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db HERACROSS
	db SCOPE_LENS
	db CUT, ROCK_SMASH, BULK_UP, HORN_ATTACK
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db BEEDRILL
	db KINGS_ROCK
	db X_SCISSOR, PIN_MISSILE, SWORDS_DANCE, SLUDGE_BOMB
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db PORYGON2
	db BRIGHTPOWDER
	db PSYCHIC_M, HEADBUTT, CALM_MIND, ICY_WIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db BLISSEY
	db BRIGHTPOWDER
	db FIRE_PUNCH, SOFTBOILED, BODY_SLAM, CALM_MIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 13005
...
; BattleTowerMons group 2
	...
	db WIGGLYTUFF
	db HELD_QUICK_CLAW
	db DRAIN_KISS, DIZZY_PUNCH, ICE_PUNCH, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db SMEARGLE
	db HELD_QUICK_CLAW
	db SPORE, SACRED_FIRE, GROWTH, CALM_MIND
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db EXEGGUTOR
	db HELD_QUICK_CLAW
	db BODY_SLAM, SLEEP_POWDER, PSYBEAM, RECOVER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db HITMONCHAN
	db BLACKGLASSES
	db BULK_UP, PURSUIT, MACH_PUNCH, ICE_PUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db CLEFABLE
	db MINT_BERRY
	db MINIMIZE, REST, CALM_MIND, TRI_ATTACK
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db FARFETCH_D
	db BRIGHTPOWDER
	db SWORDS_DANCE, DRILL_PECK, LEAF_BLADE, CROSS_CHOP
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db FLAREON
	db CHARCOAL
	db FLAME_WHEEL, SHADOW_BALL, BITE, MUD_SLAP
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db NIDOQUEEN
	db HELD_QUICK_CLAW
	db DRAIN_KISS, EARTHQUAKE, ICE_BEAM, THUNDER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 13005
...
; BattleTowerMons group 3
	...
	db DUGTRIO
	db SOFT_SAND
	db EARTHQUAKE, ROCK_SLIDE, FAINT_ATTACK, CRUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db POLIWRATH
	db HELD_QUICK_CLAW
	db SURF, ICE_PUNCH, STRENGTH, BULK_UP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db ELECTRODE
	db BRIGHTPOWDER
	db RAPID_SPIN, THUNDERBOLT, SURF, TOXIC
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db MAROWAK
	db THICK_CLUB
	db BONEMERANG, SLUDGE_BOMB, ANCIENTPOWER, SWORDS_DANCE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db JYNX
	db MYSTIC_WATER
	db BUBBLEBEAM, ICE_BEAM, GIGA_DRAIN, DRAIN_KISS
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db STEELIX
	db BRIGHTPOWDER
	db OUTRAGE, ROCK_SLIDE, ROCK_SMASH, CRUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db URSARING
	db GOLD_BERRY
	db EARTHQUAKE, METAL_CLAW, SUBMISSION, SLASH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db HOUNDOOM
	db FOCUS_BAND
	db DARK_PULSE, FLAMETHROWER, IRON_TAIL, SHADOW_BALL
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db NOCTOWL
	db LEFTOVERS
	db HYPNOSIS, DREAM_EATER, SHADOW_BALL, LIGHT_SCREEN
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db SUDOWOODO
	db MAGNET
	db FAINT_ATTACK, ROCK_SLIDE, EARTHQUAKE, HEAD_SMASH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db ARIADOS
	db HELD_QUICK_CLAW
	db GUILLOTINE, MEGAHORN, MEAN_LOOK, PURSUIT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 13005
...
; BattleTowerMons group 4
	...
	db FORRETRESS
	db HELD_QUICK_CLAW
	db TOXIC, PROTECT, SEED_BOMB, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db VILEPLUME
	db LEFTOVERS
	db SLEEP_POWDER, GIGA_DRAIN, DRAIN_PUNCH, MOONLIGHT
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db ELECTRODE
	db PINK_BOW
	db RAPID_SPIN, FLASH_CANNON, THUNDER_WAVE, FLARE_BLITZ
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db MURKROW
	db BRIGHTPOWDER
	db SWAGGER, NASTY_PLOT, FLY, DARK_PULSE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db CLEFABLE
	db GOLD_BERRY
	db ENCORE, THUNDER_WAVE, CALM_MIND, BODY_SLAM
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db MEGANIUM
	db PINK_BOW
	db BODY_SLAM, LEECH_SEED, REFLECT, RAZOR_LEAF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
	...
	db ARBOK
	db HELD_QUICK_CLAW
	db EARTHQUAKE, GLARE, POISON_FANG, CRUNCH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 13005
...
; BattleTowerMons group 5
	...
	db CLOYSTER
	db LEFTOVERS
	db ICE_FANG, TOXIC, PROTECT, IRON_DEFENSE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db DEWGONG
	db MIRACLEBERRY
	db REST, ICE_BEAM, WHIRLPOOL, SING
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db BLASTOISE
	db MAGNET
	db FLASH_CANNON, BUBBLEBEAM, EARTHQUAKE, BODY_SLAM
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db PORYGON2
	db HELD_QUICK_CLAW
	db CALM_MIND, HYPER_BEAM, IRON_TAIL, RECOVER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db POLIWRATH
	db LEFTOVERS
	db DRAIN_PUNCH, BULK_UP, BODY_SLAM, ROCK_SMASH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db CHARIZARD
	db LEFTOVERS
	db DRAGON_DANCE, FLY, EARTHQUAKE, ROCK_SLIDE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MEGANIUM
	db LEFTOVERS
	db BODY_SLAM, MORNING_SUN, EARTHQUAKE, SWORDS_DANCE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SCYTHER
	db SCOPE_LENS
	db X_SCISSOR, SWORDS_DANCE, CUT, SLASH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SKARMORY
	db LEFTOVERS
	db SPIKES, HURRICANE, TOXIC, PROTECT
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db DONPHAN
	db KINGS_ROCK
	db HEADBUTT, EARTHQUAKE, FOCUS_ENERGY, ANCIENTPOWER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db STEELIX
	db HELD_QUICK_CLAW
	db CURSE, IRON_TAIL, ROCK_SLIDE, CRUNCH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db GRANBULL
	db MINT_BERRY
	db DRAIN_KISS, CRUNCH, REST, METRONOME
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MAGCARGO
	db LEFTOVERS
	db ANCIENTPOWER, CURSE, FLAMETHROWER, ROCK_SLIDE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db DODRIO
	db FOCUS_BAND
	db EARTHQUAKE, SWORDS_DANCE, DRILL_PECK, TRI_ATTACK
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SNORLAX
	db MIRACLEBERRY
	db DRAIN_KISS, HYPNOSIS, EARTHQUAKE, BODY_SLAM
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
...
; BattleTowerMons group 6
	...
	db WOBBUFFET
	db FOCUS_BAND
	db SHADOW_BALL, CALM_MIND, HYPNOSIS, CHARM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db ELECTRODE
	db FOCUS_BAND
	db RAPID_SPIN, FLARE_BLITZ, FLASH_CANNON, THUNDER_WAVE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db GENGAR
	db FOCUS_BAND
	db ICE_PUNCH, SHADOW_BALL, HYPNOSIS, DREAM_EATER
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db GENGAR
	db LEFTOVERS
	db SHADOW_BALL, TOXIC, MEAN_LOOK, GIGA_DRAIN
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db WEEZING
	db LEFTOVERS
	db THUNDERBOLT, NASTY_PLOT, SLUDGE_BOMB, AIR_SLASH
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db WEEZING
	db LEFTOVERS
	db HURRICANE, FIRE_BLAST, PROTECT, TOXIC
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MUK
	db LEFTOVERS
	db EARTHQUAKE, MINIMIZE, SLUDGE_BOMB, FIRE_BLAST
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db CLOYSTER
	db FOCUS_BAND
	db RAPID_SPIN, ICICLE_SPEAR, ICE_FANG, SPIKES
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MISDREAVUS
	db FOCUS_BAND
	db THUNDERBOLT, CONFUSE_RAY, MOONBLAST, SHADOW_BALL
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SNORLAX
	db HELD_QUICK_CLAW
	db BULK_UP, EARTHQUAKE, DOUBLE_EDGE, ROCK_SMASH
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db STEELIX
	db FOCUS_BAND
	db DRAGON_RUSH, CRUNCH, ROCK_SLIDE, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SUDOWOODO
	db FOCUS_BAND
	db HEAD_SMASH, ROCK_SLIDE, FAINT_ATTACK, THUNDERPUNCH
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db GOLEM
	db HELD_QUICK_CLAW
	db COMET_PUNCH, ROCK_SLIDE, IRON_TAIL, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db EXEGGUTOR
	db HELD_QUICK_CLAW
	db SHADOW_BALL, GIGA_DRAIN, PSYCHIC_M, HYPNOSIS
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db DEWGONG
	db FOCUS_BAND
	db SING, WHIRLPOOL, ICE_BEAM, SURF
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db AZUMARILL
	db LEFTOVERS
	db PLAY_ROUGH, BULK_UP, HYPER_BEAM, DIZZY_PUNCH
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, BONEMERANG, ROCK_SLIDE, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db POLITOED
	db FOCUS_BAND
	db SING, WHIRLPOOL, ICE_BEAM, CONFUSE_RAY
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db LAPRAS
	db FOCUS_BAND
	db DRAGONBREATH, SING, THUNDERBOLT, SURF
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db JYNX
	db HELD_QUICK_CLAW
	db SING, PSYCHIC_M, DRAIN_KISS, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db WIGGLYTUFF
	db HELD_QUICK_CLAW
	db SING, DRAIN_KISS, METRONOME, CHARM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
...
; BattleTowerMons group 7
	...
	db ARIADOS
	db BRIGHTPOWDER
	db CONSTRICT, SWORDS_DANCE, DOUBLE_TEAM, MEGAHORN
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db AIPOM
	db FOCUS_BAND
	db THRASH, AGILITY, HONE_CLAWS, LOW_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db GIRAFARIG
	db HELD_QUICK_CLAW
	db ZEN_HEADBUTT, AGILITY, CURSE, CRUNCH
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db VENOMOTH
	db MIRACLE_SEED
	db BUG_BUZZ, DOUBLE_TEAM, GIGA_DRAIN, PSYCHIC_M
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db FARFETCH_D
	db HELD_QUICK_CLAW
	db LEAF_BLADE, SWORDS_DANCE, CUT, CROSS_CHOP
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SCIZOR
	db FOCUS_BAND
	db AGILITY, METAL_CLAW, SWORDS_DANCE, CUT
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SCYTHER
	db SCOPE_LENS
	db AGILITY, SWORDS_DANCE, CUT, SLASH
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MR__MIME
	db TWISTEDSPOON
	db REFLECT, DOUBLESLAP, CALM_MIND, PSYCHIC_M
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db UMBREON
	db LEFTOVERS
	db MUD_SLAP, DOUBLE_TEAM, CURSE, PURSUIT
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db ESPEON
	db FOCUS_BAND
	db MUD_SLAP, PSYCHIC_M, GROWTH, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db VAPOREON
	db BRIGHTPOWDER
	db ICE_BEAM, DOUBLE_TEAM, GROWTH, SURF
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db JOLTEON
	db SPELL_TAG
	db DOUBLE_TEAM, GROWTH, THUNDERBOLT, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db SMEARGLE
	db HELD_QUICK_CLAW
	db TOXIC, GROWTH, SPORE, SACRED_FIRE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db LEDIAN
	db LEFTOVERS
	db BUG_BUZZ, AGILITY, COMET_PUNCH, ICE_PUNCH
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 32512
...
; BattleTowerMons group 8
	...
	db MUK
	db LEFTOVERS
	db CURSE, EARTHQUAKE, SLUDGE_BOMB, MUD_SLAP
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db NIDOKING
	db HELD_QUICK_CLAW
	db EARTHQUAKE, SLUDGE_BOMB, SUBMISSION, THUNDER
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db DRAGONITE
	db LEFTOVERS
	db FIRE_BLAST, BLIZZARD, DRACO_METEOR, THUNDER_WAVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 65025
...
; BattleTowerMons group 9
	...
	db STEELIX
	db HELD_QUICK_CLAW
	db DRAGON_RUSH, IRON_TAIL, EARTHQUAKE, ROCK_SLIDE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db MEGANIUM
	db LEFTOVERS
	db LEECH_SEED, BODY_SLAM, GIGA_DRAIN, MORNING_SUN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db ESPEON
	db BRIGHTPOWDER
	db PSYCHIC_M, SHADOW_BALL, CALM_MIND, MORNING_SUN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db BLISSEY
	db LEFTOVERS
	db TOXIC, SOFTBOILED, METRONOME, DRAIN_KISS
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db HERACROSS
	db HELD_QUICK_CLAW
	db CROSS_CHOP, MEGAHORN, BULK_UP, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db UMBREON
	db BERSERK_GENE
	db DOUBLE_TEAM, TOXIC, PURSUIT, MOONLIGHT
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65025
...
; BattleTowerMons group 10
	...
	db SUICUNE
	db LEFTOVERS
	db RAIN_DANCE, LIGHT_SCREEN, ICE_BEAM, HYDRO_PUMP
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db MEWTWO
	db LEFTOVERS
	db RECOVER, CALM_MIND, PSYCHIC_M, FLAMETHROWER
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db CELEBI
	db BERSERK_GENE
	db DRAIN_KISS, ANCIENTPOWER, RECOVER, RETURN
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65025
	...
	db LUGIA
	db SCOPE_LENS
	db RECOVER, AEROBLAST, WATERFALL, HURRICANE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 65025
