...
; BattleTowerMons group 5
	...
	db GRANBULL
	db BRIGHTPOWDER
	db DRAIN_KISS, CRUNCH, HEAL_BELL, METRONOME
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 32512
...
; BattleTowerMons group 6
	...
	db WOBBUFFET
	db FOCUS_BAND
	db SHADOW_BALL, SAFEGUARD, HYPNOSIS, MIRROR_COAT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db WEEZING
	db LEFTOVERS
	db THUNDERBOLT, NASTY_PLOT, SLUDGE_BOMB, PAIN_SPLIT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
	...
	db MISDREAVUS
	db FOCUS_BAND
	db THUNDERBOLT, CONFUSE_RAY, PAIN_SPLIT, SHADOW_BALL
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 32512
